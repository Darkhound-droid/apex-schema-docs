...
begin
  ...
  wwv_flow_application_install.set_application_id(nvl(wwv_flow_application_install.get_application_id, 110));
  wwv_flow_application_install.set_schema(nvl(wwv_flow_application_install.get_schema, user));
  wwv_flow_application_install.set_offset(nvl(wwv_flow_application_install.get_offset, 0));
...
begin
    wwv_flow_api.create_flow(
        ...
        p_owner                        => nvl(wwv_flow_application_install.get_schema, user),
